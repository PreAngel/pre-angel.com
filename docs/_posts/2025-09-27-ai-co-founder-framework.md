...
tags:
  ...
  - ShipFail
  - Solo Founder
image: assets/2025/09-ai-co-founder-framework/ai-co-founder-framework.webp
---

*What if your startup team wasn’t just human?*
...
This line of thinking led to the birth of the **AI Co-Founder Framework** — a methodology I use at [PreAngel](https://pre-angel.com) and [Ship.Fail](https://ship.fail) to design, build, and orchestrate **agent teams** like co-founders.
...
At [Ship.Fail](https://ship.fail), we run 1-day build loops:
...
I’m applying it daily at [PreAngel](https://pre-angel.com), where I build solo AI-native tools, and at [Ship.Fail](https://ship.fail), where I prototype ideas through 1-day builds.
